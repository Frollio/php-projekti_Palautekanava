...
function do_html_heading($heading) { // Tulostaa H2-otsikon
  // print heading
?>
...
function display_user_menu() {
  ...
  ?>
  <hr>
  <a href="jasensivu.php">Jäsensivu</a> &nbsp;|&nbsp;
  ...
  ?>
  <a href="vaihda_salasana.php">Vaihda salasana</a> &nbsp;|&nbsp;
...
function display_nonuser_menu() {
  echo '<a href="rekisteroityminen.php">Rekisteröityminen</a> &nbsp;|&nbsp;';
  echo '<a href="kirjautuminen.php">Kirjaudu sisään</a> &nbsp;|&nbsp;';
  echo '<a href="unohtuiko_salasana.php">Unohtuiko salasana?</a>';
}
